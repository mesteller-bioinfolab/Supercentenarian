...
main() {
  rm -fR ./real/outputs/blood/*
 
  ANN_KEY=./real/inputs/CSQ_KEY_78
  ...
  INPUT_DIR=/gpfs42/projects/lab_anavarro/disease_pleiotropies/supercentenarian/Olot/05-make-table/real/outputs
