...
# sex
cat ${CATEGORY_GENES}.sex.genes | grep -f ${GENELISTS_FOLDER}/${GENELIST}_ensg.txt > ${OUTPUTS}/${TISSUED}.${IDD}.eur_rare_${CATEGORY}.${GENELIST}.chrX

# mt
cat ${CATEGORY_GENES}.mitochondrial.genes | grep -f ${GENELISTS_FOLDER}/${GENELIST}_ensg.txt > ${OUTPUTS}/${TISSUED}.${IDD}.eur_rare_${CATEGORY}.${GENELIST}.chrM
