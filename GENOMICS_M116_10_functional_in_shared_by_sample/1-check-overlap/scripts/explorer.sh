...
CAT_OUT=$(cat ${INPUTS}/${TISSUED}.${IDD}.${CATEGORYWORD}.autosomal.genes | grep -v -f ${OVERLAP_DIR}/${TISSUED}.${IDD}.eur_rare_${CATEGORY}.${GENESET} | wc -l)
...
CAT_IN=$(cat ${INPUTS}/${TISSUED}.${IDD}.eur_rare.autosomal.genes | grep -f ${CAT_BG_DIR}/everyones.${CATEGORY}.genes  | grep -f ${OVERLAP_DIR}/${TISSUED}.${IDD}.eur_rare_all.${GENESET} |wc -l)
CAT_OUT=$( cat ${INPUTS}/${TISSUED}.${IDD}.eur_rare.autosomal.genes | grep -f ${CAT_BG_DIR}/everyones.${CATEGORY}.genes | grep -v -f ${OVERLAP_DIR}/${TISSUED}.${IDD}.eur_rare_all.${GENESET} | wc -l)
