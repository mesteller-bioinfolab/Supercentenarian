...
main(){
  ...
  INPUTS_DIR=/gpfs42/projects/lab_anavarro/disease_pleiotropies/supercentenarian/1000GIBS/12-rva

  #ls .. | grep -v join > ./real/inputs/tests.txt
  #TEST_FOLDERS=./real/inputs/tests.txt
