...
# Run
VEP=${INPUTS_DIR}/${TISSUED}/${IDD}/${TISSUED}.${IDD}.${CHR}.filtered

gatk VariantsToTable -V $VEP -O ${OUTPUTS_DIR}/${TISSUED}/${IDD}/${TISSUED}.${IDD}.${CHR}.filtered.table -F CHROM -F POS -F ID -F REF -F ALT -F QUAL -F FILTER -F ANN
