...
main() {
  ...
  #cp ../0-gene-lists/real/outputs/gwas/gwas_genes_ensg.txt ./real/tmp	
   cp /gpfs42/projects/lab_anavarro/disease_pleiotropies/supercentenarian/Olot/10-functional-in-shared-by-sample/0-gene-lists/real/outputs/gwas/gwas_genes_ensg.txt ./real/tmp
