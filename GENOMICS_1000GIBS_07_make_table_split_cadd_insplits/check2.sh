...
# step 2 
echo ${IDD} ${CHR} $(la real/tmp/1000GIBS/${IDD}/* | grep chr${CHR}_ | grep "header" | wc -l)  $(la real/tmp_1308_2/1000GIBS/${IDD}/* | grep chr${CHR}_ | grep insplits | wc -l)>> insplits_chr_step2.txt
